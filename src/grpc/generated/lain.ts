...
export const LainVizService = {
   ...
   */
  compile: {
    path: "/lain.viz.LainViz/Compile" as const,
   ...
   */
  networkStream: {
    path: "/lain.viz.LainViz/NetworkStream" as const,
    requestStream: false as const,
   ...
   */
  session: {
    path: "/lain.viz.LainViz/Session" as const,
  ...
  openSession: {
    path: "/lain.viz.LainViz/OpenSession" as const,
    requestStream: false as const,
    responseStream: true as const,
  ...
  pushDeltas: {
    path: "/lain.viz.LainViz/PushDeltas" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  cardBuild: {
    path: "/lain.viz.LainViz/CardBuild" as const,
    requestStream: false as const,
    responseStream: false as const,
