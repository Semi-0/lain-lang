...
- **Protocol concepts and server/client usage:** [CONNECT-PROTOCOL.md](../protocol/CONNECT-PROTOCOL.md)
- **E2E:** lain-viz `docs/guides/E2E-SMOKE.md` — run Connect server, then viz; no proxy.
- **Implementation plan:** lain-viz `docs/planning/IMPLEMENTATION-PLAN.md` §4.1 — transport and Connect backend.
